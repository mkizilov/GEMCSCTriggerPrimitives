      ...
      for (int sect = min_sector; sect <= max_sector; sect++) {
        for (int subs = min_subsector; subs <= numsubs; subs++) {
          for (int cham = min_chamber; cham <= max_chamber; cham++) {
            ...
            //MK Debugging
            //std::cout<<"Printing emulator variables: ";
            // bool mk_debug = true;
            // if (mk_debug) 
            // { 
            // //std::cout<<"\n EVENT DATA\n";
            // for (const auto &preTriggerBX : preTriggerBXs) {
            //     std::cout<<"\npreTriggerBXs: ";
            //     std::cout<<preTriggerBX;
            // }
            ...
            // }
            // // for (auto detUnitIt = oc_clct.begin(); detUnitIt != oc_clct.end(); detUnitIt++) {
            ...
            // //     }
            // // }
            // for(const auto &pretrigger : pretriggerV) {
            //     if(pretrigger.isValid()) {
            //         std::cout<<"\npretriggerV: ";
            //         std::cout<<pretrigger;
            //     }
            // }
            // // for(auto detUnitIt = oc_pretrigger.begin(); detUnitIt != oc_pretrigger.end(); detUnitIt++) {
            // //     //CSCDetId id = (*detUnitIt).first;
            // //     auto range = (*detUnitIt).second;
            // //     for(auto digiIt = range.first; digiIt != range.second; digiIt++) {
            // //         if((*digiIt).isValid()) {
            ...
            // //     }
            // // }
            // for(const auto &shower : cathodeShower) {
            //   if(shower.isValid()) {
            //     std::cout<<"\ncathodeShower: ";
            //     std::cout << shower << std::endl;
            //   }
            // }
            // for(auto detUnitIt = oc_shower_cathode.begin(); detUnitIt != oc_shower_cathode.end(); detUnitIt++) {
            //     //CSCDetId id = (*detUnitIt).first;
            //     auto range = (*detUnitIt).second;
            //     for(auto digiIt = range.first; digiIt != range.second; digiIt++) {
            //         if((*digiIt).isValid()) {
