...
runReader = True # Set to True if you want to run the EDM Reader part to get an output root file with Track data.
...
# flist = open("bad_events.list")
# for evt in flist:
#   process.source.eventsToProcess.append(evt)
...
if runReader:
      ...
      process.TFileService = cms.Service("TFileService", fileName = cms.string("out_GEMCSCTriggerPrimitivesReader.root"))
